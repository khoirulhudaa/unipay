          ...
          return (
              <>
                ...
                <select 
                    ...
                    name={name} 
                    ref={ref}
                    className={`mt-3 border-0 px-3 py-4 w-full outline-2 outline-blue-400 rounded-md text-[14px] box-sizing ${onError && onTouched ? 'border-red-500 text-[red]' : ''} ${disabled ? 'bg-slate-300 cursor-not-allowed text-slate-500' : 'bg-white' }`} 
                    value={value} 
